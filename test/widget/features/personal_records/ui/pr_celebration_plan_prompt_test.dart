...
/// when the screen fires `pr_celebration_seen` / `add_to_plan_prompt_responded`.
...
/// Returns the analytics-related overrides that every test in this file needs
/// so the screen can safely read `authRepositoryProvider` and
/// `analyticsRepositoryProvider` without initialising Supabase.
List<Override> _analyticsOverrides() {
